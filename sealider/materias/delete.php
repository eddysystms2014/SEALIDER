        ...
        <div class="gtco-container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="col-md-7 col-md-offset-3">Control de Materias</h3>
                    <form class="form-horizontal" action="../controller/controllerMat.php">
                        ...
                        <ul class="gtco-social-icons pull-left">
                            <?php
                            echo "<li><a href='../controller/controllerMat.php?op=eliminar&id_materia=" . $id_materia = $_REQUEST['id_materia'] . "'><img src='../images/si.png' style='width:5em;height:5em'></a></li>";
                            ?> 
                            </ul>
