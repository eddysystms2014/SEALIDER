...
<html>
    ...
    <body>
    <?php
        $materia = unserialize($_SESSION['materia']);
    ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="id_materia"  value="<?php echo $materia->getID_MATERIA(); ?>" readonly="readonly" required>  
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        while ($valores = mysqli_fetch_array($query)) {
                            echo '<option value="'.$valores[CED_INSTRUCTOR].'">'.$valores[CED_INSTRUCTOR].' - '.$valores[NOMBRE_APELLIDO].'</option>';
                            }?>
                        </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="descripcion" value="<?php echo $materia->getDESCRIPCION(); ?>" pattern="[a-zA-Z\s]*" >
                        </div>
                    </div>
                    <div class="form-group">
