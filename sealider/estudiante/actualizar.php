            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" pattern="[0-9]{10}" maxlength="10" value="<?php echo $estudiante->getCED_ESTUDIANTE(); /* captura dato y envia no visible */ ?>" name="ced_estudiante" readonly="readonly" required >  
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">NOMBRE Y APELLIDO:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" pattern="[a-zA-Z\s]*" value="<?php echo $estudiante->getNOMBRE_APELLIDO(); ?>" name="nombre_apellido" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">EMAIL:</label>
                        <div class="col-sm-8">
                            <input type="email" class="form-control" value="<?php echo $estudiante->getEMAIL(); ?>" name="email">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">NRO. TEL&Eacute;FONO:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" pattern="[0-9]*" value="<?php echo $estudiante->getNROTELF(); ?>" maxlength="10" name="nrotelf">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">CONGREGACI&Oacute;N</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" pattern="[a-zA-Z\s]*" value="<?php echo $estudiante->getCONGREGACION(); ?>" name="congregacion" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">CARGO</label>
                        <div class="col-sm-8">
                            <select class="form-control" value="<?php echo $estudiante->getCARGO(); ?>" name="cargo">
