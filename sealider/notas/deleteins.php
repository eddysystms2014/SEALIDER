        ...
        <div class="gtco-container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="col-md-7 col-md-offset-3">Control de Notas</h3>
                    <form class="form-horizontal" action="../controller/controllerNotIns.php">
                        ...
                        <ul class="gtco-social-icons pull-left">
                            <?php
                            echo "<li><a href='../controller/controllerNotIns.php?op=eliminarins&id=" . $id = $_REQUEST['id'] . "'><img src='../images/si.png' style='width:5em;height:5em'></a></li>";
                            ?> 
                            </ul>
                            <ul class="gtco-social-icons pull-right">
                            <?php
                             echo "<li><a href='indexins.php'><img src='../images/no.png' style='width:5em;height:5em'></a></li>";
                            ?> 
                         </ul>
                        </p>
                    </form>
