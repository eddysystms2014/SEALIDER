...
<html>
    ...
    <header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(../images/banner-bg3.jpg)">
        ...
        <div class="gtco-container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal" action="../notas/wmconsultar_alumno.php" method="POST">
                    <div class="form-group">
                        <label class="control-label col-sm-4">C&Eacute;DULA:</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" pattern="[0-9]{10}" maxlength="10" name="cedula" placeholder="Ingrese nro. de c&eacute;dula" required> 
                        </div>
                    </div>
                        <div class="form-group">
					<input type="submit" class="btn btn-primary col-md-offset-5" value="CONSULTAR">
				</div>
                    </form>           
