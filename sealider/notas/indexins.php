		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
                                    <div id="gtco-logo"><a href="../docente.php">INICIO</a></div>
				</div>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group">
						<input type="hidden" name="op" value="insertarins">
	...
	<div class="gtco-container">
		<div class="row">
			<div class="col-md-12">
				...
				<form action="../controller/controllerNotIns.php">
                ...
                foreach ($listado as $not) {
                   	...
                   	echo "<td class='warning'><a href='deleteins.php?op=eliminarins&id=" . $not->getID() . "'><img src='../images/eliminarmat.png' style='width:2em;height:2em'></a></td>";
                   	echo "<td class='active'><a href='../controller/controllerNotIns.php?op=editarins&id=".$not->getID()."'><img src='../images/actualizarmat.png' style='width:2em;height:2em'></a></td>";
                   	echo "</tr>";
               		}
            	} else {
