            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" value="<?php echo $usuario->getID(); ?>" name="id" readonly="readonly" required >  
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">USUARIO:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control"  pattern="[0-9]{10}" maxlength="10" value="<?php echo $usuario->getUSUARIO(); ?>" name="usuario" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">CONTRASE&Ntilde;A:</label>
                        <div class="col-sm-8">
                            <input type="password" class="form-control" value="<?php echo $usuario->getCONTRASENA(); ?>" name="contrasena" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4">TIPO:</label>
                        <div class="col-sm-8">
                            <select class="form-control" title="Seleccione" name="tipo" required>
