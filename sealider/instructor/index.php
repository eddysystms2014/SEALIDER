			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" pattern="[0-9]{10}" maxlength="10" name="ced_instructor" required>	
						</div>
					</div>
					<div class="form-group">
		...
		<div class="row">
			<div class="col-md-12">
                ...
                foreach ($listado as $ins) {
                   	...
                   	echo "<td class='warning'><a href='delete.php?op=eliminar&ced_instructor=" . $ins->getCED_INSTRUCTOR() . "'><img src='../images/eliminarest.png' style='width:2em;height:2em'></a></td>";
                   	echo "<td class='active'><a href='../controller/controllerIns.php?op=editar&ced_instructor=".$ins->getCED_INSTRUCTOR()."'><img src='../images/actualizarins.png' style='width:2em;height:2em'></a></td>";
                   	echo "</tr>";
               		}
            	} else {
