        ...
        <div class="gtco-container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="col-md-7 col-md-offset-3">Control de Docentes</h3>
                    <form class="form-horizontal" action="../controller/controllerIns.php">
                        ...
                        <ul class="gtco-social-icons pull-left">
                            <?php
                            echo "<li><a href='../controller/controllerIns.php?op=eliminar&ced_instructor=" . $ced_instructor = $_REQUEST['ced_instructor'] . "'><img src='../images/si.png' style='width:5em;height:5em'></a></li>";
                            ?> 
                            </ul>
